framework.angular.controllers.controller("fieldDataUpdateCtrl",function($scope,$rootScope,fieldDataRES,categoryListRES){
    fieldDataRES.get({
        method:"detail",
        id :$.query.get("id")
        ...
        $(".J_keyWord").val($scope.project.typeName);
