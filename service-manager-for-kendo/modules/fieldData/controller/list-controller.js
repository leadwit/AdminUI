framework.angular.controllers.controller("fieldDataList",function($scope,fieldDataRES){
    var url = framework.getFinalURL('field/list.do?method=list','api/fieldData.json?1=1');
    ...
    $scope.leadingOut=function()
    {
        ...
        if(_data.length>0){
            ...
            if ( confirm('您确定要导出您选择的数据吗？')){
                ...
                location.href="../../../doc/api.do?method=exp&ids="+ids+"&expDataType=F";
            }
        }
    }
    //导出
