framework.angular.controllers.controller("merchantIpList",function($scope,merchantIpRES){
    var url = framework.getFinalURL('merchant/ip.do?method=list','api/merchantIp.json?1=1');
