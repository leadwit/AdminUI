framework.angular.controllers.controller("category.list",function($scope,categoryRES){
    var url = framework.getFinalURL('category/info.do?method=list','api/category.json?1=1');
    ...
    $scope.leadingOut=function()
    {
        ...
        if(_data.length>0){
            ...
            if ( confirm('您确定要导出您选择的数据吗？')){
                ...
                location.href="../../../doc/api.do?method=exp&ids="+ids+"&expDataType=C";
            }
        }
    }
    //导出
