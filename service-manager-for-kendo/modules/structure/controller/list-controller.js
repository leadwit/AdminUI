framework.angular.controllers.controller("structureList",function($scope,structureRES){
    var url = framework.getFinalURL('structure/info.do?method=list','api/structure.json?1=1');
