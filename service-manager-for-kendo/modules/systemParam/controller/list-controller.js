framework.angular.controllers.controller("systemParamList",function($scope,systemParamRES){
    var url = framework.getFinalURL('system/param.do?method=list','api/systemParam.json?1=1');
