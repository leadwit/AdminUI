framework.angular.controllers.controller("merchantCertList",function($scope,merchantCertRES){
    var url = framework.getFinalURL('merchant/cert.do?method=list','api/merchantCert.json?1=1');
