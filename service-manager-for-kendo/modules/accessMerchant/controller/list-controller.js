framework.angular.controllers.controller("accessMerchantList",function($scope,$rootScope,accessMerchantRES){
    $rootScope.loading = true;

    var url = framework.getFinalURL('apilist/api.do?method=list','api/accessMerchant.json?1=1');
