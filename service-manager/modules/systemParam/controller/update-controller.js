(function($) {
    ...
    ngmod.controller("systemParamUpdateCtrl",function($scope,systemParamRES,systemParamTRES){
        systemParamRES.get({
            method:"detail",
            id :$.query.get("id")
        ...
        $scope.save = function(invalid) {
            ...
            systemParamRES.save({'method':"update"},$scope.project, function(project) {
                if(project.respCode=="00"){
                    alert('操作成功');
                    window.location.href="systemParamList.shtml";
                }else {
