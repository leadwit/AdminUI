(function($) {
    ...
    ngmod.controller("merchantApiUpdateCtrl",function($scope,merchantApiRES){
        merchantApiRES.get({
            method:"detail",
            id : $.query.get("id")
        }, function(projects) {
        ...
        $scope.save = function(invalid) {
            ...
            var tab_scope = angular.element("#tab2").scope();
            ...
            merchantApiRES.save({'method':"add"},$scope.project, function(project) {
                if(project.respCode=="00"){
                    alert('温馨提示：操作成功');
                    window.location.href="#/merchantApi/list/";
                }else {
    ...
    ngmod.controller("tab2Ctrl",function($scope,serviceRES){
